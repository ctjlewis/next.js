...
async function loadWebpackHook(phase, dir) {
    ...
    try {
        ...
        if (result.reason === 'future-flag') {
            ...
            if (phase !== _constants.PHASE_PRODUCTION_SERVER && !result.enabled) {
                Log.info(`Using webpack 4 in Next.js is deprecated. Please upgrade to using webpack 5: https://nextjs.org/docs/messages/webpack5`);
            }
        }
