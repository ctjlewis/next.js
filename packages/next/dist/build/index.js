    ...
    const buildResult = await nextBuildSpan.traceAsyncFn(async ()=>{
        ...
        const { customAppGetInitialProps , namedExports , isNextImageImported , hasSsrAmpPages , hasNonStaticErrorPage ,  } = await staticCheckSpan.traceAsyncFn(async ()=>{
            ...
            const errorPageStaticResult = nonStaticErrorPageSpan.traceAsyncFn(async ()=>{
                var ref, ref9;
                return hasCustomErrorPage && staticWorkers.isPageStatic('/_error', distDir, isLikeServerless, runtimeEnvConfig, config.httpAgentOptions, (ref = config.i18n) === null || ref === void 0 ? void 0 : ref.locales, (ref9 = config.i18n) === null || ref9 === void 0 ? void 0 : ref9.defaultLocale);
            });
                    ...
                    if (nonReservedPage) {
                        try {
                            ...
                            let workerResult = await isPageStaticSpan.traceAsyncFn(()=>{
                                var ref, ref13;
                                return staticWorkers.isPageStatic(page, distDir, isLikeServerless, runtimeEnvConfig, config.httpAgentOptions, (ref = config.i18n) === null || ref === void 0 ? void 0 : ref.locales, (ref13 = config.i18n) === null || ref13 === void 0 ? void 0 : ref13.defaultLocale, isPageStaticSpan.id);
                            });
