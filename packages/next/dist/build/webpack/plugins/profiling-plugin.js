...
function getNormalModuleLoaderHook(compilation) {
    if (_webpack.isWebpack5) {
        ...
        return _webpack.NormalModule.getCompilationHooks(compilation).loader;
    }
...
class ProfilingPlugin {
    ...
    traceTopLevelHooks(compiler) {
        this.traceHookPair('webpack-compilation', compiler.hooks.compilation, _webpack.isWebpack5 ? compiler.hooks.afterCompile : compiler.hooks.done, {
