...
exports.NODE_RESOLVE_OPTIONS = exports.NODE_ESM_RESOLVE_OPTIONS = void 0;
...
async function getBaseWebpackConfig(dir, { buildId , config , dev =false , isServer =false , pagesDir , target ='server' , reactProductionProfiling =false , entrypoints , rewrites , isDevFallback =false , runWebpackSpan  }) {
    ...
    let webpackConfig = {
        ...
        plugins: [
          ...
          `
            ...
            config.experimental.outputFileTracing && !isLikeServerless && isServer && !dev && _webpack.isWebpack5 && new _nextTraceEntrypointsPlugin.TraceEntryPointsPlugin({
                appDir: dir
            }),
    ...
    if (_webpack.isWebpack5) {
        ...
        (ref = webpackConfig.output) === null || ref === void 0 ? void 0 : delete ref.futureEmitAssets;
        ...
        const cache = {
            ...
            version: `${"11.1.3-canary.41"}|${configVars}`,
    ...
    if (typeof originalEntry !== 'undefined') {
        const updatedEntry = async ()=>{
            ...
            for (const name of Object.keys(entry)){
                entry[name] = (0, _entries).finalizeEntrypoint(name, entry[name], isServer, _webpack.isWebpack5);
            }
            return entry;
        };
